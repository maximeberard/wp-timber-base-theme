        ...
        .pipe(
            requirejsOptimize({
                ...
                paths: {
                    ...
                    //CSSPlugin: "empty:",
                    isMobile:
                        "./../bower_components/vanilla-lazyload/dist/lazyload",
                    Lazyload: "./../bower_components/isMobile/isMobile.min",
                    waitForImages:
                        "./../bower_components/waitForImages/dist/jquery.waitforimages.min",
                    loglevel:
                        "./../bower_components/loglevel/dist/loglevel.min",
